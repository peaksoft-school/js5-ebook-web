export const books = [
   {
      ...
      images: {
         mainImg:
            'https://book24.ua/upload/iblock/c7d/c7de50c50c62414e395c819335196c8b.jpg',
         secondImg:
            'https://anylang.net/sites/default/files/styles/responsive_grid/public/covers/harry-potter-and-chamber-secrets.jpg?itok=DSKElf4l',
         thirdImg:
   ...
   {
      id: '4249204596',
      name: 'Женщина у которой есть план',
      genre: 'Aroma Housewares',
      price: '$40.00',
      language: 'Русский',
      publishingHouse: 'МСК',
      year: '2021',
